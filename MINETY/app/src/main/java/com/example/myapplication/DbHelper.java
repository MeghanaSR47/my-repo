...
//    private static final String INSERT= "INSERT INTO "+CLASS_TABLE_NAME+ "( " +
//            C_ID + " , " +
//            CLASS_NAME_KEY + " , " +
//            SUBJECT_NAME_KEY + " ) " +" VALUES(1,'ISE','CO');";
//
//    private static final String INSERT_DSC= "INSERT INTO "+CLASS_TABLE_NAME+ "( " +
//            C_ID + " , " +
//            CLASS_NAME_KEY + " , " +
//            SUBJECT_NAME_KEY + " ) " +" VALUES(2,'ISE','DSC');";
//
//    private static final String INSERT_OOP= "INSERT INTO "+CLASS_TABLE_NAME+ "( " +
//            C_ID + " , " +
//            CLASS_NAME_KEY + " , " +
//            SUBJECT_NAME_KEY + " ) " +" VALUES(3,'ISE','OOP');";
...
//        db.execSQL(INSERT);
//        db.execSQL(INSERT_DSC);
//        db.execSQL(INSERT_OOP);
    }
